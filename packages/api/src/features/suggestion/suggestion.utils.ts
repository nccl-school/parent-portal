...
export const GetSuggestionReactionsSchema = z.object({ id: z.string() });

export const GetSuggestionReactionsPerUserSchema = z.object({
  ...GetSuggestionReactionsSchema.shape,
  user_id: z.string(),
});
