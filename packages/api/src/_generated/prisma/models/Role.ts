...
export type RoleWhereInput = {
  ...
  id?: Prisma.EnumRoleNameFilter<"Role"> | $Enums.RoleName
...
export type RoleScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.EnumRoleNameWithAggregatesFilter<"Role"> | $Enums.RoleName
...
export type RoleUpdateInput = {
  id?: Prisma.EnumRoleNameFieldUpdateOperationsInput | $Enums.RoleName
...
export type RoleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "label" | "description", ExtArgs["result"]["role"]>
...
export interface RoleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const roleWithLabelOnly = await prisma.role.findMany({ select: { label: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Roles and only return the `label`
   * const roleWithLabelOnly = await prisma.role.createManyAndReturn({
   *   select: { label: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Roles and only return the `label`
   * const roleWithLabelOnly = await prisma.role.updateManyAndReturn({
   *   select: { label: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface RoleFieldRefs {
  readonly id: Prisma.FieldRef<"Role", 'RoleName'>
